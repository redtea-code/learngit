...
def main(argv: list[str] | None = None) -> int:
    ...
    # while the portable final mapping uses Arimo for Arial and an open DejaVu
    # or Noto source for the remaining OS-family choices; injecting only at
    # final render would change wrapping *after* the strict fill gate passed.
